package com.junioroffers.infrastructure.scheduler;
...
public class HttpOfferScheduler {
    ...
    private  static final String ADDED_MEW_OFFERS_MESSAGE = "Added new {} offers";
    ...
    public List<OfferResponseDto> fetchAllOffersAndSaveAllIfNotExists(){
        ...
        log.info(ADDED_MEW_OFFERS_MESSAGE, addedOffers.size());
